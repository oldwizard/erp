...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fas fa-home"></i> Home</a></li>
        <li class="active">Arhiva</li>
    </ol>
</section>
        ...
        <section class="col-lg-12 connectedSortable">
            <div class="box ">
                ...
                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 250px;"><div class="box-body chat" id="chat-box" style="overflow: hidden; width: auto; height: 250px;">
                        <!-- chat item -->
                        <div class="item">
                            <img src="http://razvoj.mondena.net/erp/assets/dist/img/user4-128x128.jpg" alt="user image" class="online">
                        ...
                        <!-- chat item -->
                        <div class="item">
                            <img src="http://razvoj.mondena.net/erp/assets/dist/img/user3-128x128.jpg" alt="user image" class="offline">
                        ...
                        <!-- chat item -->
                        <div class="item">
                            <img src="http://razvoj.mondena.net/erp/assets/dist/img/user2-160x160.jpg" alt="user image" class="offline">
